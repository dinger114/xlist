...
/// XSlider is like Slider in Flutter SDK.
/// XSlider support [cacheValue] which can be used
...
/// 兼容旧引用名的别名
typedef NewFijkSlider = XSlider;
typedef NewFijkSliderColors = XSliderColors;
