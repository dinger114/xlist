const Map<String, String> enUs = {
  ...
  'parent_path': 'Path',
  'toast_no_selection': 'Please select files first',
  'toast_select_one_only': 'Only one item can be selected for this action',
  'toast_copy_batch': '@count files copied',
  'toast_move_batch': '@count files moved',
  'toast_remove_batch': '@count files deleted',
  'settings_data_storage': 'Data Storage',
  'settings_backup': 'Data Backup',
  'settings_backup_to_alist': 'Backup to Alist',
  'settings_restore_from_alist': 'Restore from Alist',
  'settings_database_path': 'Database',
  'settings_preferences_path': 'Preferences',
  'settings_data_path_tap': 'Tap to copy path',
