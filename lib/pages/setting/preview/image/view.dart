        ...
        child: SingleChildScrollView(
          ...
          child: CupertinoListSection.insetGrouped(
            ...
            header: Container(
              ...
              child: Text(
                'setting_preview_image_title'.tr,
                style: Get.textTheme.bodySmall,
              ),
            ),
            children: [
              for (var type in kSupportPreviewImageTypes)
                _buildListTile(
                  title: type,
                  leading: Obx(
                    () => controller.imageSupportTypes.contains(type)
                        ? Icon(
                  ...
                  onTap: () => controller.toggleImageSupportType(type),
                ),
            ],
          ),
        ),
